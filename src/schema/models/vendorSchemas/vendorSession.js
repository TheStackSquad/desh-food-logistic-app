//src/schema/models/vendorSchemas/vendorSession.js
...
vendorSessionSchema.index({ vendor: 1, status: 1 });
vendorSessionSchema.index({ createdAt: -1 });
...
// Export the model
const VendorSession = mongoose.models.VendorSession || mongoose.model('VendorSession', vendorSessionSchema);

export default VendorSession;
