        ...
        <form onSubmit={formik.handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              <input
                id="cardNumber" // Added id to associate with label
                type="text"
                name="cardNumber"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                id="expiryDate" // Added id to associate with label
                type="text"
                name="expiryDate"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  id="securityCode" // Added id to associate with label
          ...
          <div>
            ...
            <input
              id="zipCode" // Added id to associate with label
              type="text"
              name="zipCode"
