...
export default function RiderLanding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-700 to-blue-500 overflow-hidden relative">
      ...
      <motion.div 
        className="absolute top-1/4 left-1/4 w-64 h-64 rounded-full opacity-20 filter blur-xl"
        animate={{
          scale: [1, 1.2, 1],
          rotate: [0, 90, 0],
        }}
      ...
      {/* Main content */}
      <div className="container mx-auto px-4 h-screen flex items-center justify-center relative z-10 bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-600">
  <motion.div 
  ...
  >
    ...
    <motion.p 
      className="text-xl text-blue-500 max-w-2xl mx-auto mb-8 drop-shadow-md"
      initial={{ opacity: 0, x: 20 }}
      animate={{ opacity: 1, x: 0 }}
